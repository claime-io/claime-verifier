...
var ContractsMetaData = &bind.MetaData{
	ABI: "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"claimer\",\"type\":\"address\"},{\"components\":[{\"internalType\":\"string\",\"name\":\"propertyType\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"propertyId\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"method\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"evidence\",\"type\":\"string\"}],\"indexed\":false,\"internalType\":\"structIClaimRegistry.Claim\",\"name\":\"claim\",\"type\":\"tuple\"}],\"name\":\"ClaimRemoved\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"claimer\",\"type\":\"address\"},{\"components\":[{\"internalType\":\"string\",\"name\":\"propertyType\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"propertyId\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"method\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"evidence\",\"type\":\"string\"}],\"indexed\":false,\"internalType\":\"structIClaimRegistry.Claim\",\"name\":\"claim\",\"type\":\"tuple\"}],\"name\":\"ClaimUpdated\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"allClaimKeys\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"allClaims\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"propertyType\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"propertyId\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"method\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"evidence\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"listClaims\",\"outputs\":[{\"internalType\":\"uint256[]\",\"name\":\"\",\"type\":\"uint256[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"propertyType\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"propertyId\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"method\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"evidence\",\"type\":\"string\"}],\"name\":\"register\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"propertyType\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"propertyId\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"method\",\"type\":\"string\"}],\"name\":\"remove\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
//
// Solidity: function allClaims(uint256 ) view returns(string propertyType, string propertyId, string method, string evidence)
func (_Contracts *ContractsCaller) AllClaims(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Method = *abi.ConvertType(out[2], new(string)).(*string)
	outstruct.Evidence = *abi.ConvertType(out[3], new(string)).(*string)
...
//
// Solidity: function listClaims(address account) view returns(uint256[])
func (_Contracts *ContractsCaller) ListClaims(opts *bind.CallOpts, account common.Address) ([]*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function listClaims(address account) view returns(uint256[])
func (_Contracts *ContractsSession) ListClaims(account common.Address) ([]*big.Int, error) {
...
//
// Solidity: function listClaims(address account) view returns(uint256[])
func (_Contracts *ContractsCallerSession) ListClaims(account common.Address) ([]*big.Int, error) {
	return _Contracts.Contract.ListClaims(&_Contracts.CallOpts, account)
}

// Register is a paid mutator transaction binding the contract method 0x0e24c52c.
//
// Solidity: function register(string propertyType, string propertyId, string method, string evidence) returns()
func (_Contracts *ContractsTransactor) Register(opts *bind.TransactOpts, propertyType string, propertyId string, method string, evidence string) (*types.Transaction, error) {
	return _Contracts.contract.Transact(opts, "register", propertyType, propertyId, method, evidence)
}

// Register is a paid mutator transaction binding the contract method 0x0e24c52c.
//
// Solidity: function register(string propertyType, string propertyId, string method, string evidence) returns()
func (_Contracts *ContractsSession) Register(propertyType string, propertyId string, method string, evidence string) (*types.Transaction, error) {
	return _Contracts.Contract.Register(&_Contracts.TransactOpts, propertyType, propertyId, method, evidence)
}

// Register is a paid mutator transaction binding the contract method 0x0e24c52c.
//
// Solidity: function register(string propertyType, string propertyId, string method, string evidence) returns()
func (_Contracts *ContractsTransactorSession) Register(propertyType string, propertyId string, method string, evidence string) (*types.Transaction, error) {
	return _Contracts.Contract.Register(&_Contracts.TransactOpts, propertyType, propertyId, method, evidence)
}
...
// FilterClaimRemoved is a free log retrieval operation binding the contract event 0x288f7cec6535cec42094ddba6c823fe9dc1507b8b280861eebdf01dcbecdbba2.
//
// Solidity: event ClaimRemoved(address claimer, (string,string,string,string) claim)
...
// WatchClaimRemoved is a free log subscription operation binding the contract event 0x288f7cec6535cec42094ddba6c823fe9dc1507b8b280861eebdf01dcbecdbba2.
//
// Solidity: event ClaimRemoved(address claimer, (string,string,string,string) claim)
...
// ParseClaimRemoved is a log parse operation binding the contract event 0x288f7cec6535cec42094ddba6c823fe9dc1507b8b280861eebdf01dcbecdbba2.
//
// Solidity: event ClaimRemoved(address claimer, (string,string,string,string) claim)
