...
func (_Erc721 *Erc721Caller) Deployer(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "deployer")
...
//
// Solidity: function deployer() view returns(address)
func (_Erc721 *Erc721Session) Deployer() (common.Address, error) {
	return _Erc721.Contract.Deployer(&_Erc721.CallOpts)
}

// Deployer is a free data retrieval call binding the contract method 0xd5f39488.
//
// Solidity: function deployer() view returns(address)
func (_Erc721 *Erc721CallerSession) Deployer() (common.Address, error) {
	return _Erc721.Contract.Deployer(&_Erc721.CallOpts)
}
...
func (_Erc721 *Erc721Caller) Gateway(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "gateway")
...
//
// Solidity: function gateway() view returns(address)
func (_Erc721 *Erc721Session) Gateway() (common.Address, error) {
	return _Erc721.Contract.Gateway(&_Erc721.CallOpts)
}

// Gateway is a free data retrieval call binding the contract method 0x116191b6.
//
// Solidity: function gateway() view returns(address)
func (_Erc721 *Erc721CallerSession) Gateway() (common.Address, error) {
	return _Erc721.Contract.Gateway(&_Erc721.CallOpts)
}
...
//
// Solidity: function mintTo(address _address, uint256 _uid) returns()
func (_Erc721 *Erc721Transactor) MintTo(opts *bind.TransactOpts, _address common.Address, _uid *big.Int) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "mintTo", _address, _uid)
}

// MintTo is a paid mutator transaction binding the contract method 0x449a52f8.
//
// Solidity: function mintTo(address _address, uint256 _uid) returns()
func (_Erc721 *Erc721Session) MintTo(_address common.Address, _uid *big.Int) (*types.Transaction, error) {
	return _Erc721.Contract.MintTo(&_Erc721.TransactOpts, _address, _uid)
}

// MintTo is a paid mutator transaction binding the contract method 0x449a52f8.
//
// Solidity: function mintTo(address _address, uint256 _uid) returns()
func (_Erc721 *Erc721TransactorSession) MintTo(_address common.Address, _uid *big.Int) (*types.Transaction, error) {
	return _Erc721.Contract.MintTo(&_Erc721.TransactOpts, _address, _uid)
}

// MintToGateway is a paid mutator transaction binding the contract method 0x544297f5.
//
// Solidity: function mintToGateway(uint256 _uid) returns()
func (_Erc721 *Erc721Transactor) MintToGateway(opts *bind.TransactOpts, _uid *big.Int) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "mintToGateway", _uid)
}

// MintToGateway is a paid mutator transaction binding the contract method 0x544297f5.
//
// Solidity: function mintToGateway(uint256 _uid) returns()
func (_Erc721 *Erc721Session) MintToGateway(_uid *big.Int) (*types.Transaction, error) {
	return _Erc721.Contract.MintToGateway(&_Erc721.TransactOpts, _uid)
}

// MintToGateway is a paid mutator transaction binding the contract method 0x544297f5.
//
// Solidity: function mintToGateway(uint256 _uid) returns()
func (_Erc721 *Erc721TransactorSession) MintToGateway(_uid *big.Int) (*types.Transaction, error) {
	return _Erc721.Contract.MintToGateway(&_Erc721.TransactOpts, _uid)
}
